...
test_str38 = "{nil, 1, [1] = 'haha\t'}"
test_str39 = "{nil, [1]=1}"
test_str40 = " {1,nil,2,a =2} "
test_str41 = "{123}"
test_str42 = r""" --a
{
--1
...
#pyt.loadLuaTable("py_test_input3.txt")
#d = pyt.dumpDict()
#print d
...
a1.loadLuaTable("py_test_input2.txt")
a1.dumpLuaTable("1.txt")
#a1.loadLuaTable("1.txt")
#d1 = a1.dumpDict()
#print d1
